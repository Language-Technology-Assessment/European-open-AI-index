...
Like many "open" models, Teuken is perhaps better characterised as "open weights" than as "open source". But whereas many model providers share both base models and final models ([>50 in our index](https://osai-index.eu/the-index?type=text&view=bars&weights_basemodel=1&weights_endmodel=1)), for Teuken only the final model weights are openly shared, with the base models available only upon request and fully at the discretion of the model provider. 
