...
In general, we find that Teuken is coined as open while not matching openness standards across many metrics. Perhaps it is just very hard to release a model that is meaningfully open?
